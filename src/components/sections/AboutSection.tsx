...
export function AboutSection() {
  ...
  return <section id="about" className="section standard-section"><SectionCommand command="cat ./about_me.txt" index="01" label="about" /><div className="section-heading"><span className="section-kicker">FILE: 01 / 07</span><h2>About <span>me.</span></h2><p>A little context behind the code.</p></div><TerminalPanel title="about_me.txt"><div className="about-content">
