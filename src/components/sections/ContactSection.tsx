...
export function ContactSection() {
  ...
  return <section id="contact" className="section standard-section contact-section"><SectionCommand command="./contact --init" index="07" label="connection" /><div className="section-heading"><span className="section-kicker">PORT: OPEN</span><h2>Let's <span>connect.</span></h2><p>Have an idea, opportunity, or just want to say hello?</p></div><div className="contact-grid"><div className="contact-copy"><div className="contact-large">Let's build<br /><span>something good.</span></div><p>I'm open to thoughtful projects, collaboration, and new challenges. Drop a message and let's see where it goes.</p>
