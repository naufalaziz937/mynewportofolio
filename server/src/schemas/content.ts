...
export const personalCategorySchema = z.enum(['hobbies', 'currently', 'favorites', 'dream-setup', 'dream-garage', 'dream-home', 'career-goal', 'life-goal', 'bucket-list', 'fun-facts', 'personal-quote']);
export const personalItemSchema = z.object({ category: personalCategorySchema, title: text(160), description: optionalText(1000), image: optionalUrl, imagePublicId: optionalText(200), imageAlt: optionalText(200), label: optionalText(80), icon: optionalText(60), status: optionalText(80), url: optionalUrl, completed: z.boolean(), size: z.enum(['small', 'wide', 'tall', 'large']), displayMode: z.enum(['visual', 'text']), order, visible: z.boolean() }).strict();
